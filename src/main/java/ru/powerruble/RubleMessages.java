...
public final class RubleMessages {
    ...
    private static Properties defaultProperties() {
        ...
        properties.setProperty("help.sell", "/sell <игрок> <цена> [комментарий], /buyconfirm, /buycancel - прямая сделка предметом из руки");
        ...
        properties.setProperty("sale.self", "Нельзя продать предмет самому себе.");
        properties.setProperty("sale.empty-hand", "В основной руке нет предмета для продажи.");
        properties.setProperty("sale.offer.sent", "Вы предложили игроку {target} купить {item} за {amount}.");
        properties.setProperty("sale.offer.sent.comment", "Вы предложили игроку {target} купить {item} за {amount}. Комментарий: {comment}");
        properties.setProperty("sale.offer.received", "{seller} предлагает вам купить {item} за {amount}. Выполните /buyconfirm или /buycancel.");
        properties.setProperty("sale.offer.received.comment", "{seller} предлагает вам купить {item} за {amount}. Комментарий: {comment}. Выполните /buyconfirm или /buycancel.");
        properties.setProperty("sale.seller-offline", "Продавец уже не в сети.");
        properties.setProperty("sale.item-changed", "Продавец больше не держит тот же предмет в основной руке.");
        properties.setProperty("sale.buyer-inventory-full", "У вас нет свободного слота для этой покупки.");
        properties.setProperty("sale.sold", "{buyer} купил у вас {item} за {amount}.");
        properties.setProperty("sale.sold.comment", "{buyer} купил у вас {item} за {amount}. Комментарий: {comment}");
        properties.setProperty("sale.cancelled", "{buyer} отменил покупку предмета {item}.");
        properties.setProperty("buyconfirm.none", "Нет покупки, ожидающей подтверждения.");
        properties.setProperty("buyconfirm.expired", "Предложение покупки устарело.");
        properties.setProperty("buyconfirm.done", "Вы купили {item} у {seller} за {amount}.");
        properties.setProperty("buyconfirm.done.comment", "Вы купили {item} у {seller} за {amount}. Комментарий: {comment}");
        properties.setProperty("buycancel.done", "Покупка предмета {item} у {seller} отменена.");
